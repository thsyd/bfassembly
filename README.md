...
The removed duplicates were writen to a .tab file for later review, and [Pfam_replicationdomain_unique.fasta](../blob/Pfam_replicationdomain_unique.fasta) used to build a protein sequence database with ABRicate.
```
