...
The removed duplicates were writen to a .tab file for later review, and [Pfam_replicationdomain_unique.fasta](../Pfam_replicationdomain_unique.fasta) used to build a protein sequence database with ABRicate.
```
